...
class PDF extends FPDF
{
    ...
    function Header(){
        ...
        $this->Cell(170,10,'LISTA INFORMACION DE ACTORES EN PROGRAMAS',0,0,'C');
        //salto de linea
        $this->Ln(20);
    }
    //PIE
...
$pdf->Cell(40, 10, 'ID Programa', 1, 0, 'C', 0);
$pdf->Cell(40, 10, 'ID Actor', 1, 1, 'C', 0);
$c=1;
$pdf->SetFont('Arial','',10);
while($row = $resultado->fetch_assoc()){
    $pdf->SetX(60);
    $pdf->Cell(15, 10, $c , 1, 0, 'C', 0);
    $pdf->Cell(40, 10, $row['idprog'], 1, 0, 'C', 0);
    $pdf->Cell(40, 10, $row['idactor'], 1, 1, 'C', 0);
    $c+=1;    
}
