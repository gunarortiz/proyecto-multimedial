...
class PDF extends FPDF
{
    ...
    function Header(){
        ...
        $this->Cell(130,10,'LISTA INFORMACION DE CANALES',0,0,'C');
        //salto de linea
        $this->Ln(20);
    }
    //PIE
...
$pdf->Cell(30, 10, 'Numero Canal', 1, 0, 'C', 0);
...
while($row = $resultado->fetch_assoc()){
    ...
    $pdf->Cell(30, 10, $row['nroemi'], 1, 0, 'C', 0);
    $pdf->Cell(50, 10, $row['nombrec'], 1, 1, 'C', 0);
    $c+=1;    
}
