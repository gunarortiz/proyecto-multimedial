...
class PDF extends FPDF
{
    ...
    function Header(){
        ...
        $this->Cell(140,10,'LISTA INFORMACION DE TRANSMISION',0,0,'C');
        //salto de linea
        $this->Ln(20);
    }
    //PIE
...
$consulta = "SELECT * FROM se_transmite";
...
$pdf->Cell(30, 10, 'ID Canal', 1, 0, 'C', 0);
$pdf->Cell(30, 10, 'ID Episodio', 1, 0, 'C', 0);
$pdf->Cell(50, 10, 'Hora Inicio', 1, 0, 'C', 0);
$pdf->Cell(50, 10, 'Hora Fin', 1, 1, 'C', 0);
$c=1;
$pdf->SetFont('Arial','',10);
while($row = $resultado->fetch_assoc()){
    $pdf->SetX(17);
    $pdf->Cell(15, 10, $c , 1, 0, 'C', 0);
    $pdf->Cell(30, 10, $row['idcanal'], 1, 0, 'C', 0);
    $pdf->Cell(30, 10, $row['idepi'], 1, 0, 'C', 0);
    $pdf->Cell(50, 10, $row['hora_ini'], 1, 0, 'C', 0);
    $pdf->Cell(50, 10, $row['hora_fin'], 1, 1, 'C', 0);
    $c+=1;    
}
