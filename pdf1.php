...
$pdf->AddPage();
    ...
    $pdf->Cell(80);
    // Título
    $pdf->Cell(50,10,'- PERSONAL ENCARGADO DE LA ILUMINACION -',0,0,'C');
    $pdf->Ln(30);
...
WHERE (t.mat_trabajo LIKE 'vestuario') AND (t.idtec LIKE p.idpersona)";
...
$pdf->Cell(80);
// Título
$pdf->Cell(50,10,'- PERSONAL ENCARGADO DEL VESTUARIO -',0,0,'C');
$pdf->Ln(30);
...
WHERE (t.mat_trabajo LIKE 'decoracion') AND (t.idtec LIKE p.idpersona)";
...
$pdf->AddPage();
    ...
    $pdf->Cell(80);
    // Título
    $pdf->Cell(50,10,'- PERSONAL ENCARGADO DE LA DECORACION -',0,0,'C');
    $pdf->Ln(30);
...
WHERE (t.mat_trabajo LIKE 'color') AND (t.idtec LIKE p.idpersona)";
...
$pdf->AddPage();
    ...
    $pdf->Cell(80);
    // Título
    $pdf->Cell(50,10,'- PERSONAL ENCARGADO DEL COLOR -',0,0,'C');
    $pdf->Ln(30);
...
WHERE (t.mat_trabajo LIKE 'sonido') AND (t.idtec LIKE p.idpersona)";
...
$pdf->AddPage();
    ...
    $pdf->Cell(80);
    // Título
    $pdf->Cell(50,10,'- PERSONAL ENCARGADO DEL SONIDO -',0,0,'C');
    $pdf->Ln(30);
...
$pdf->AddPage();
    ...
    $pdf->Cell(80);
    // Título
    $pdf->Cell(50,10,'- PERSONAL ENCARGADO DE LA MUSICA -',0,0,'C');
    $pdf->Ln(30);
...
while($row6 = $resultado6->fetch_assoc()){
    $pdf->SetX(10);
    $pdf->Cell(30, 10, $row6['ci'], 1, 0, 'C', 0);
    $pdf->Cell(40, 10, $row6['nombre'], 1, 0, 'C', 0);
    $pdf->Cell(40, 10, $row6['apellido'], 1, 0, 'C', 0);
    $pdf->Cell(40, 10, $row6['fecha_nac'], 1, 0, 'C', 0);
    $pdf->Cell(40, 10, $row6['telefono'], 1, 1, 'C', 0);
}
$pdf->Output();
?>
