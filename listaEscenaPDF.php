...
class PDF extends FPDF
{
    ...
    function Header(){
       ...
       // $this->Image('logo.png',10,8,33);
        ...
        $this->Cell(100,10,'LISTA INFORMACION DE ESCENAS',0,0,'C');
        //salto de linea
        $this->Ln(20);
    }
    //PIE
...
$pdf->Cell(30, 10, 'Nro de Escena', 1, 0, 'C', 0);
$pdf->Cell(40, 10, 'ID Epesodio', 1, 0, 'C', 0);
$pdf->Cell(40, 10, 'Duracion (min)', 1, 1, 'C', 0);
$c=1;
$pdf->SetFont('Arial','',10);
while($row = $resultado->fetch_assoc()){
    $pdf->SetX(40);
    $pdf->Cell(15, 10, $c , 1, 0, 'C', 0);
    $pdf->Cell(30, 10, $row['nroescena'], 1, 0, 'C', 0);
    $pdf->Cell(40, 10, $row['idepi'], 1, 0, 'C', 0);
    $pdf->Cell(40, 10, $row['duracion'], 1, 1, 'C', 0);
    $c+=1;    
}
