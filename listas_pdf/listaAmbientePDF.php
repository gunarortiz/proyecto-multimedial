...
class PDF extends FPDF
{
    ...
    function Header(){
        ...
        $this->Cell(130,10,'LISTA INFORMACION DE AMBIENTES',0,0,'C');
        //salto de linea
        $this->Ln(20);
...
$pdf->Cell(30, 10, 'ID Ambiente', 1, 0, 'C', 0);
$pdf->Cell(50, 10, 'Tipo', 1, 1, 'C', 0);
$c=1;
$pdf->SetFont('Arial','',10);
while($row = $resultado->fetch_assoc()){
    $pdf->SetX(55);
    $pdf->Cell(15, 10, $c , 1, 0, 'C', 0);
    $pdf->Cell(30, 10, $row['idambiente'], 1, 0, 'C', 0);
